---
description: Create a detailed implementation plan for a REST API endpoint based on the provided specification
argument-hint: [api-endpoint-spec]
---
...
Remember to save your implementation plan as .ai/{{lowercase-endpoint-method}}{{endpoint-path}}-implementation-plan.md. Ensure the plan is detailed, clear, and provides comprehensive guidance for the development team.
